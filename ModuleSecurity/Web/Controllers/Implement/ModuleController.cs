...
namespace Web.Controllers.Implement
{
    ...
    public class ModuleController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DataModuleDto>>> GetAll()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<DataModuleDto>> GetById(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Module>> Save([FromBody] DataModuleDto entity)
        {
            if (entity == null)
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update([FromBody] DataModuleDto entity)
        {
